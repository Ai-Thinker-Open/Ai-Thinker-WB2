...
COMPONENT_SRCS := platform/HAL_Device_freertos.c \
				  ...
				  sdk_src/file_manage_client.c \
				  sdk_src/gateway_api.c \
			      sdk_src/gateway_common.c \
				  sdk_src/kgmusic_client.c \
				  sdk_src/location.c \
			      sdk_src/resource_lib.c \
			      sdk_src/resource_mqtt.c \
				  sdk_src/resource_upload.c
