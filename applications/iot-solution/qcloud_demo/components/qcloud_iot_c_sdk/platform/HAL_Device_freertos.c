...
#define DEBUG_DEV_INFO_USED
    ...
    /* product Id  */
    static char sg_product_id[MAX_SIZE_OF_PRODUCT_ID + 1] = "GEFVZNWRVT";

    /* device name */
    static char sg_device_name[MAX_SIZE_OF_DEVICE_NAME + 1] = "plug001";
    ...
    static char sg_region[MAX_SIZE_OF_REGION + 1] = "china";
        ...
        static char sg_product_secret[MAX_SIZE_OF_PRODUCT_SECRET + 1] = "MOyuuzitGnjSH4uWL6S6Pw==";
    #endif

#elif WIFI_PROV_BT_COMBO_CONFIG_ENABLE
    /* product Id  */
    static char sg_product_id[MAX_SIZE_OF_PRODUCT_ID + 1] = "GEFVZNWRVT";

    /* device name */
    static char sg_device_name[MAX_SIZE_OF_DEVICE_NAME + 1] = "fangshouchou";
    ...
    #ifdef DEV_DYN_REG_ENABLED
        /* product secret for device dynamic Registration  */
        static char sg_product_secret[MAX_SIZE_OF_PRODUCT_SECRET + 1] = "hB4zoiDkAz2BNU610U99xw==";
    #endif
#endif
...
static char sg_device_privatekey_file_name[MAX_SIZE_OF_DEVICE_SECRET_FILE_NAME + 1] = "YOUR_DEVICE_NAME_private.key";
        ...
        static char sg_device_secret[MAX_SIZE_OF_DEVICE_SECRET + 1] = "MOyuuzitGnjSH4uWL6S6Pw==";
    #elif WIFI_PROV_BT_COMBO_CONFIG_ENABLE
        static char sg_device_secret[MAX_SIZE_OF_DEVICE_SECRET + 1] = "hB4zoiDkAz2BNU610U99xw==";
    #endif
#endif
