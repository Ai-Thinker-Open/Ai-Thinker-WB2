...
static int32_t _core_mqtt_conn_pkt(core_mqtt_handle_t *mqtt_handle, uint8_t **pkt, uint32_t *pkt_len)
{
    ...
    /* Payload Length */
    conn_paylaod_len = (uint32_t)(strlen(mqtt_handle->clientid) + strlen(mqtt_handle->username) + strlen(mqtt_handle->password) + 3 * CORE_MQTT_UTF8_STR_EXTRA_LEN);
...
static int32_t _core_mqtt_connect(core_mqtt_handle_t *mqtt_handle)
{
    ...
    mqtt_handle->nwkstats_info.connect_time_used = mqtt_handle->sysdep->core_sysdep_time() - mqtt_handle->nwkstats_info.connect_timestamp;
...
static int32_t _core_mqtt_pingresp_handler(core_mqtt_handle_t *mqtt_handle, uint8_t *input, uint32_t len)
{
    ...
    uint64_t rtt = mqtt_handle->sysdep->core_sysdep_time() - mqtt_handle->heartbeat_params.last_send_time;
