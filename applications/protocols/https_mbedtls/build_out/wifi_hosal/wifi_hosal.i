# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/wifi_hosal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
# 29 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/include/wifi_hosal.h" 1
# 24 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/include/wifi_hosal.h"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/_stdint.h" 1 3
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/_stdint.h" 3
...
# 28 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/features.h" 3
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/toolchain/riscv/Linux/riscv64-unknown-elf/include/_newlib_version.h" 1 3
# 29 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/features.h" 2 3
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/toolchain/riscv/Linux/riscv64-unknown-elf/include/machine/_default_types.h" 2 3
...
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/_stdint.h" 2 3
...
# 25 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/include/wifi_hosal.h" 2
# 33 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/include/wifi_hosal.h"
...
# 34 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/include/wifi_hosal.h" 2
...
# 49 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/types.h" 3
...
# 30 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c" 2
# 55 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_efuse_read_mac(uint8_t mac[6])
{
  return g_wifi_hosal_funcs.efuse_read_mac(mac);
}
# 72 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_rf_turn_on(void *arg)
{
  return g_wifi_hosal_funcs.rf_turn_on(arg);
}
# 89 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_rf_turn_off(void *arg)
{
  return g_wifi_hosal_funcs.rf_turn_off(arg);
}
# 106 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
hosal_adc_dev_t* wifi_hosal_adc_device_get(void)
{
  return g_wifi_hosal_funcs.adc_device_get();
}
# 124 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_adc_tsen_value_get(hosal_adc_dev_t *adc)
{
  return g_wifi_hosal_funcs.adc_tsen_value_get(adc);
}
# 140 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_pm_init(void)
{
  return g_wifi_hosal_funcs.pm_init();
}
# 156 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_pm_event_register(enum PM_EVEMT event, uint32_t code, uint32_t cap_bit, uint16_t pirority, bl_pm_cb_t ops, void *arg, enum PM_EVENT_ABLE enable)
{
  return g_wifi_hosal_funcs.pm_event_register(event, code, cap_bit, pirority, ops, arg, enable);
}
# 172 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_pm_deinit(void)
{
  return g_wifi_hosal_funcs.pm_deinit();
}
# 188 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_pm_state_run(void)
{
  return g_wifi_hosal_funcs.pm_state_run();
}
# 204 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_pm_capacity_set(enum PM_LEVEL level)
{
  return g_wifi_hosal_funcs.pm_capacity_set(level);
}
# 220 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_pm_post_event(enum PM_EVEMT event, uint32_t code, uint32_t *retval)
{
  return g_wifi_hosal_funcs.pm_post_event(event, code, retval);
}
# 236 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_hosal/wifi_hosal.c"
int wifi_hosal_pm_event_switch(enum PM_EVEMT event, uint32_t code, enum PM_EVENT_ABLE enable)
{
