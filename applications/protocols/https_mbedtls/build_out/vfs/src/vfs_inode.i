# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 2
...
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/include/vfs_conf.h" 1
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 2
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 2
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 2


struct rb_tree *inode_rb_tree = 
# 14 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
                               ((void *)0)
# 14 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                                   ;
...
int inode_init()
{
    int ret = 0;
    if (
# 37 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
       ((void *)0) 
# 37 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
            == inode_rb_tree) {
        inode_rb_tree = rb_tree_create(inode_cmp_cb);
        if (
# 39 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
           ((void *)0) 
# 39 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                == inode_rb_tree) {
            ret = -1;
        }
    }
...
int inode_alloc(inode_t **node)
{
    *node = pvPortMalloc(sizeof(inode_t));
    ...
    do { if (!(
# 50 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0) 
# 50 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
...
int inode_del(inode_t *node)
{
    if (node->refs > 0) {
        return -
# 60 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3
               16
# 60 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                    ;
    }
    ...
    if (node->refs == 0) {
        ...
        if (node->i_name != 
# 65 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 65 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                               ) {
...
int inode_forearch_name(int (*cb)(void *arg, inode_t *node), void *arg)
{
    ...
    if (
# 96 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
       ((void *)0) 
# 96 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
            == iter) {
        node_num = 0;
        goto exit;
    }
    ...
    if (
# 103 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
       ((void *)0) 
# 103 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
            == node) {
    ...
    for (i = 0; i < node_num; i++) {
        if (
# 110 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
           ((void *)0) 
# 110 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                != node->i_name) {
            if (cb(arg, node)) {
                break;
            }
        ...
        if (
# 116 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
           ((void *)0) 
# 116 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                == node) {
            break;
        }
    }
...
int inode_ptr_get(int fd, inode_t **node)
{
# 136 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
    return 0u;
}
...
static int inode_set_name(const char *path, inode_t **inode)
{
    ...
    do { if (!(
# 169 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0) 
# 169 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
...
int inode_reserve(const char *path, inode_t **inode)
{
    int ret;
    inode_t *node = 
# 181 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
                   ((void *)0)
# 181 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                       ;

    do { if (!(path != 
# 183 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0) 
# 183 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
   && inode != 
# 183 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 183 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
   )) return -
# 183 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3
   22
# 183 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
   ; } while(0);
    *inode = 
# 184 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
            ((void *)0)
# 184 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                ;
    ...
    if (path[0] == '\0' || path[0] != '/') {
        ...
        return -
# 192 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3
               22
# 192 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                     ;
    }

    if (
# 195 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
       ((void *)0) 
# 195 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
            == inode_rb_tree || 30 <= rb_tree_size(inode_rb_tree)) {
        printf("inode_rb_tree is NULL when inode alloc\r\n");
        return -
# 197 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3
               22
# 197 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
    ...
    if (!(rb_tree_insert(inode_rb_tree, node))) {
        ...
        vPortFree(node);
        return -
# 214 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3
               12
# 214 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
...
int inode_release(const char *path)
{
    ...
    do { if (!(path != 
# 226 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 226 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
   )) return -
# 226 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3
   22
# 226 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
   ; } while(0);
    ...
    if (node == 
# 229 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3 4
               ((void *)0)
# 229 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                   ) {
        return -
# 230 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c" 3
               19
# 230 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
