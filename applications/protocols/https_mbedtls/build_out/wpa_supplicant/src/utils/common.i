# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 2
# 23 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
void inc_byte_array(u8 *counter, size_t len)
{
 int pos = len - 1;
 while (pos >= 0) {
...
# 67 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
int hexstr2bin(const char *hex, u8 *buf, size_t len)
{
 size_t i;
 int a;
...
char * wpa_config_parse_string(const char *value, size_t *len)
{
 if (*value == '"') {
  ...
  pos = strrchr((value), ('"'));
  if (pos == 
# 241 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0) 
# 241 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
                 || pos[1] != '\0')
   return 
# 242 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 242 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
             ;
  *len = pos - value;
  str = dup_binstr(value, *len);
  if (str == 
# 245 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0)
# 245 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
                )
   return 
# 246 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 246 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
             ;
  return str;
  ...
  pos = strrchr((value), ('"'));
  if (pos == 
# 254 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0) 
# 254 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
                 || pos[1] != '\0')
   return 
# 255 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 255 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
             ;
  tlen = pos - value;
  tstr = dup_binstr(value, tlen);
  if (tstr == 
# 258 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
             ((void *)0)
# 258 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
                 )
   return 
# 259 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 259 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
             ;

  str = wpa_supplicant_malloc((tlen + 1));
  if (str == 
# 262 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0)
# 262 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
                ) {
   wpa_supplicant_free((tstr));
   return 
# 264 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 264 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
             ;
  }
  ...
  *len = printf_decode((u8 *) str, tlen + 1, tstr);
  ...
  if (hlen & 1)
   return 
# 276 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 276 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
             ;
# 289 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
  tlen = hlen / 2;
  str = wpa_supplicant_malloc((tlen + 1));
  if (str == 
# 291 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0)
# 291 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
                )
   return 
# 292 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 292 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
             ;
  if (hexstr2bin(value, str, tlen)) {
   wpa_supplicant_free((str));
   return 
# 295 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
         ((void *)0)
# 295 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
             ;
  }
  str[tlen] = '\0';
  *len = tlen;
...
char * dup_binstr(const void *src, size_t len)
{
 ...
 if (src == 
# 352 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
           ((void *)0)
# 352 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
               )
  return 
# 353 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
        ((void *)0)
# 353 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
            ;
 res = wpa_supplicant_malloc((len + 1));
 if (res == 
# 355 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
           ((void *)0)
# 355 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
               )
  return 
# 356 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
        ((void *)0)
# 356 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
            ;
 memcpy((res), (src), (len));
 res[len] = '\0';
...
int os_gmtime(os_time_t t, struct os_tm *tm)
{
 ...
 tm2 = gmtime(&t2);
 if (tm2 == 
# 401 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
           ((void *)0)
# 401 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
               )
  return -1;
 tm->sec = tm2->tm_sec;
 tm->min = tm2->tm_min;
...
char * get_param(const char *cmd, const char *param)
{
 ...
 if (!pos)
  return 
# 442 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
        ((void *)0)
# 442 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
            ;
 ...
 if (!val)
  return 
# 452 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
        ((void *)0)
# 452 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
            ;
 memcpy((val), (pos), (len));
 val[len] = '\0';
 return val;
...
# 539 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
const char * wpa_ssid_txt(const u8 *ssid, size_t ssid_len)
{
 static char ssid_txt[32 * 4 + 1];

 if (ssid == 
# 543 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c" 3 4
            ((void *)0)
# 543 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/common.c"
                ) {
  ssid_txt[0] = '\0';
  return ssid_txt;
 }
