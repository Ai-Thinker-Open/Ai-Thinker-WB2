# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
# 15 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
...
# 16 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 2
...
# 18 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/include/utils/wpabuf.h" 1
# 19 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 2
# 37 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
...
int wpabuf_resize(struct wpabuf **_buf, size_t add_len)
{
 ...
 if (buf == 
# 59 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 59 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
               ) {
  *_buf = wpabuf_alloc(add_len);
  return *_buf == 
# 61 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
                 ((void *)0) 
# 61 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
                      ? -1 : 0;
 }
# 73 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
 if (buf->used + add_len > buf->size) {
  unsigned char *nbuf;
  if (buf->ext_data) {
   nbuf = (unsigned char*)wpa_supplicant_realloc((buf->ext_data), (buf->used + add_len));
   if (nbuf == 
# 77 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
              ((void *)0)
# 77 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
                  )
    return -1;
   memset(nbuf + buf->used, 0, add_len);
   buf->ext_data = nbuf;
  } else {
# 94 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
   nbuf = (unsigned char*)wpa_supplicant_realloc((buf), (sizeof(struct wpabuf) + buf->used + add_len))
                           ;
   if (nbuf == 
# 96 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
              ((void *)0)
# 96 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
                  )
    return -1;
...
struct wpabuf * wpabuf_alloc(size_t len)
{
# 127 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
 struct wpabuf *buf = (struct wpabuf *)wpa_supplicant_zalloc(1, (sizeof(struct wpabuf) + len));
 if (buf == 
# 128 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 128 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
               )
  return 
# 129 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
        ((void *)0)
# 129 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
            ;
...
struct wpabuf * wpabuf_alloc_ext_data(u8 *data, size_t len)
{
# 147 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
 struct wpabuf *buf = (struct wpabuf *)wpa_supplicant_zalloc(1, (sizeof(struct wpabuf)));
 if (buf == 
# 148 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 148 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
               )
  return 
# 149 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
        ((void *)0)
# 149 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
            ;
...
void wpabuf_free(struct wpabuf *buf)
{
# 197 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
 if (buf == 
# 197 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 197 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
               )
  return;
...
# 225 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
struct wpabuf * wpabuf_concat(struct wpabuf *a, struct wpabuf *b)
{
 struct wpabuf *n = 
# 227 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
                   ((void *)0)
# 227 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
                       ;
 size_t len = 0;

 if (b == 
# 230 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
         ((void *)0)
# 230 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
             )
  return a;
...
# 265 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
struct wpabuf * wpabuf_zeropad(struct wpabuf *buf, size_t len)
{
 struct wpabuf *ret;
 size_t blen;
 ...
 if (buf == 
# 270 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
           ((void *)0)
# 270 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
               )
  return 
# 271 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
        ((void *)0)
# 271 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
            ;
...
# 293 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
__builtin_va_start(
# 293 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
ap
# 293 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
,
# 293 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
...
# 295 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
__builtin_va_end(
# 295 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
ap
# 295 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c" 3 4
)
# 295 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/utils/wpabuf.c"
