# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 2
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 2
...
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 2
...
# 14 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 2
...
int wpa_auth_for_each_auth(struct wpa_authenticator *wpa_auth,
      ...
      void *cb_ctx);
# 15 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.h" 1
# 16 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 2
             ...
             const u8 *pmkid)
{
    ...
    count = pos;
    pos += 2;
# 122 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
    res = rsn_cipher_put_suites(pos, conf->rsn_pairwise);
    num_suites += res;
    pos += res * 4;
# 134 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
    if (num_suites == 0) {
        do {} while(0)
                                  ;
        return -1;
    ...
    count = pos;
    pos += 2;
# 153 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
    if (conf->wpa_key_mgmt & (1U << (0))) {
...
# 176 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
...
# 208 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
    if (num_suites == 0) {
        do {} while(0)
                                  ;
        return -1;
    ...
    if (conf->ieee80211w != NO_MGMT_FRAME_PROTECTION) {
        if (pos + 2 + 4 > buf + len)
            return -1;
        if (pmkid == 
# 262 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                    ((void *)0)
# 262 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                        ) {
...
# 297 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
    hdr->len = (pos - buf) - 2;
...
# 312 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                                                    ((void *)0)
# 312 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                                                        );
        if (res < 0)
            return res;
        pos += res;
    }
# 326 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
    ...
    if (wpa_auth->wpa_ie == 
# 336 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                           ((void *)0)
# 336 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                               )
        return -1;
                                             ...
                                             )
{
    ...
    if (wpa_auth == 
# 381 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                   ((void *)0) 
# 381 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                        || sm == 
# 381 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                                 ((void *)0)
# 381 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
    ...
    if (wpa_ie == 
# 384 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                 ((void *)0) 
# 384 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                      || wpa_ie_len < 1)
...
# 573 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
    if (ciphers & (1U << (3)))
        sm->pairwise = (1U << (3));
    ...
    if (sm->wpa_ie == 
# 586 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                     ((void *)0) 
# 586 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                          || sm->wpa_ie_len < wpa_ie_len) {
        wpa_supplicant_free((sm->wpa_ie));
        sm->wpa_ie = wpa_supplicant_malloc((wpa_ie_len));
        if (sm->wpa_ie == 
# 589 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                         ((void *)0)
# 589 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                             )
            ...
            const u8 *wpa_ie, size_t wpa_ie_len)
{
    ...
    if (wpa_ie == 
# 606 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                 ((void *)0) 
# 606 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                      || wpa_ie_len < 1)
        return WPA_INVALID_IE;
    ...
    if (sm->wpa_ie == 
# 663 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                     ((void *)0) 
# 663 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                          || sm->wpa_ie_len < wpa_ie_len) {
        wpa_supplicant_free((sm->wpa_ie));
        sm->wpa_ie = wpa_supplicant_malloc((wpa_ie_len));
        if (sm->wpa_ie == 
# 666 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c" 3 4
                         ((void *)0)
# 666 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/ap/wpa_auth_ie.c"
                             )
            return WPA_ALLOC_FAIL;
    }
    memcpy(sm->wpa_ie, wpa_ie, wpa_ie_len);
