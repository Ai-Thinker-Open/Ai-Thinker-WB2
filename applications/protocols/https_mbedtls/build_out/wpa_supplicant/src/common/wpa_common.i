# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
# 15 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
...
# 16 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
...
# 17 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
...
# 18 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
...
# 19 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
...
# 20 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
...
# 21 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
...
# 22 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
...
int hmac_sha256_kdf(const u8 *secret, size_t secret_len,
            const char *label, const u8 *seed, size_t seed_len,
            u8 *out, size_t outlen);
# 23 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
...
int hmac_md5(const uint8_t *key, size_t key_len, const uint8_t *data, size_t data_len,
      uint8_t *mac);
# 24 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes.h" 1
# 23 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes.h"
...
int aes_ccm_ad(const u8 *key, size_t key_len, u8 *nonce,
               ...
               u8 *plain, 
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes.h" 3 4
                         _Bool 
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes.h"
                              skip_auth);
# 25 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 2
...
static int rsn_key_mgmt_to_bitfield(const u8 *s)
{
 ...
 if (WPA_GET_BE32((const u8 *) (s)) == ((((u32) (0x00)) << 24) | (((u32) (0x0f)) << 16) | (((u32) (0xac)) << 8) | (u32) (2)))
  return (1U << (1));
# 62 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
...
# 106 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
int wpa_parse_wpa_ie_rsn(const u8 *rsn_ie, size_t rsn_ie_len,
    struct wpa_ie_data *data)
{
 ...
 data->capabilities = 0;
 data->pmkid = 
# 121 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 3 4
              ((void *)0)
# 121 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
                  ;
 data->num_pmkid = 0;
    ...
    struct wpa_ie_data *data)
{
 ...
 data->capabilities = 0;
 data->pmkid = 
# 268 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 3 4
              ((void *)0)
# 268 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
                  ;
 data->num_pmkid = 0;
 data->mgmt_group_cipher = 0;
...
# 370 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
...
# 437 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
    if (pos[1] > 4 + 2 &&
...
# 455 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
int wpa_parse_kde_ies(const u8 *buf, size_t len, struct wpa_eapol_ie_parse *ie)
{
    const u8 *pos, *end;
    int ret = 0;
...
# 487 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
        } else if (*pos == 221) {
...
# 522 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
int wpa_eapol_key_mic(const u8 *key, int ver, const u8 *buf, size_t len,
        u8 *mic)
{
 u8 hash[20];
...
{
 if (ie1 == 
# 553 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 3 4
           ((void *)0) 
# 553 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
                || ie2 == 
# 553 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c" 3 4
                          ((void *)0)
# 553 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
 ...
 if (ie1len == ie2len && memcmp(ie1, ie2, ie1len) == 0)
  return 0;
# 582 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
 return -1;
}
# 634 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
void wpa_pmk_to_ptk(const u8 *pmk, size_t pmk_len, const char *label,
      const u8 *addr1, const u8 *addr2,
      const u8 *nonce1, const u8 *nonce2,
      u8 *ptk, size_t ptk_len, int use_sha256)
...
# 686 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/common/wpa_common.c"
void rsn_pmkid(const u8 *pmk, size_t pmk_len, const u8 *aa, const u8 *spa,
        u8 *pmkid, int use_sha256)
{
 char title[9];
