# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 2
...
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 2
...
# 14 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 2
# 25 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
int eap_hdr_len_valid(const struct wpabuf *msg, size_t min_payload)
{
 ...
 if (msg == 
# 30 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 3 4
           ((void *)0)
# 30 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
               )
  return 0;
...
# 66 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
const u8 * eap_hdr_validate(int vendor, EapType eap_type,
       const struct wpabuf *msg, size_t *plen)
{
 const struct eap_hdr *hdr;
 ...
 if (!eap_hdr_len_valid(msg, 1))
  return 
# 74 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 3 4
        ((void *)0)
# 74 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
            ;
 ...
 if (*pos == EAP_TYPE_EXPANDED) {
  ...
  if (len < sizeof(*hdr) + 8) {
   do {} while(0)
                ;
   return 
# 86 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 3 4
         ((void *)0)
# 86 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
             ;
  }
  pos++;
  ...
  if (exp_vendor != vendor || exp_type != (u32) eap_type) {
   do {} while(0)
              ;
   return 
# 96 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 3 4
         ((void *)0)
# 96 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
             ;
  }
  ...
  *plen = len - sizeof(*hdr) - 8;
  ...
  if (vendor != EAP_VENDOR_IETF || *pos != eap_type) {
   do {} while(0);
   return 
# 104 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 3 4
         ((void *)0)
# 104 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
             ;
  }
...
# 128 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
struct wpabuf * eap_msg_alloc(int vendor, EapType type, size_t payload_len,
         u8 code, u8 identifier)
{
 struct wpabuf *buf;
 ...
 if (buf == 
# 138 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 3 4
           ((void *)0)
# 138 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
               )
  return 
# 139 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c" 3 4
        ((void *)0)
# 139 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
            ;
...
# 167 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/eap_peer/eap_common.c"
void eap_update_len(struct wpabuf *msg)
{
 struct eap_hdr *hdr;
