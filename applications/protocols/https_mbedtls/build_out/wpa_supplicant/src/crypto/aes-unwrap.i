# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c"
# 31 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c"
...
# 32 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c" 2
...
# 34 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c" 2
...
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes.h"
                              skip_auth);
# 35 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c" 2
...
int __attribute__((__warn_unused_result__)) aes_128_cbc_decrypt(const u8 *key, const u8 *iv, u8 *data,
         size_t data_len);
# 36 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c" 2
# 46 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c"
int
aes_unwrap(const u8 *kek, int n, const u8 *cipher, u8 *plain)
{
 ...
 if (ctx == 
# 59 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c" 3 4
           ((void *)0)
# 59 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c"
               )
  return -1;
# 69 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-unwrap.c"
 for (j = 5; j >= 0; j--) {
  r = plain + (n - 1) * 8;
  for (i = n; i >= 1; i--) {
   memcpy((b), (a), (8));
