# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c"
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c"
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c" 2
...
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes.h"
                              skip_auth);
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c" 2
...
int __attribute__((__warn_unused_result__)) aes_128_cbc_decrypt(const u8 *key, const u8 *iv, u8 *data,
         size_t data_len);
# 14 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c" 2
...
# 42 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c"
       ...
       const u8 *addr[], const size_t *len, u8 *mac)
{
 ...
 if (ctx == 
# 51 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c" 3 4
           ((void *)0)
# 51 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c"
               )
  return -1;
 memset(cbc, 0, 16);
...
# 129 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c"
int omac1_aes_128_vector(const u8 *key, size_t num_elem,
    const u8 *addr[], const size_t *len, u8 *mac)
{
 return omac1_aes_vector(key, 16, num_elem, addr, len, mac);
}
# 148 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c"
int omac1_aes_128(const u8 *key, const u8 *data, size_t data_len, u8 *mac)
{
 return omac1_aes_128_vector(key, 1, &data, &data_len, mac);
}
# 166 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-omac1.c"
