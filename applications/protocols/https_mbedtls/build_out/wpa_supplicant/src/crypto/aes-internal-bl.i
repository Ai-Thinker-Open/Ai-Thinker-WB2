# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-internal-bl.c"
...
# 21 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/include/utils/wpa_debug.h" 2
...
# 20 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes.h" 2
...
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes.h"
                              skip_auth);
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-internal-bl.c" 2
...
int crypto_ec_point_cmp(const struct crypto_ec *e,
        ...
        const struct crypto_ec_point *b);
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-internal-bl.c" 2
...
void *wpa_aes_encrypt_init(const u8 *key, size_t len)
{
    ...
    if (!aes) {
        return 
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-internal-bl.c" 3 4
              ((void *)0)
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-internal-bl.c"
                  ;
    }
...
void *wpa_aes_decrypt_init(const u8 *key, size_t len)
{
    ...
    if (!aes) {
        return 
# 30 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-internal-bl.c" 3 4
              ((void *)0)
# 30 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/crypto/aes-internal-bl.c"
                  ;
    }
