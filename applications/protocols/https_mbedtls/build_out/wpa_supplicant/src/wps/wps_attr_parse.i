# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/wps/wps_attr_parse.c"
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/wps/wps_attr_parse.c" 2
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/wps/wps_attr_parse.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/wps/wps_attr_parse.c" 2
...
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/wps/wps_attr_parse.c" 2
...
static u16 wps_ignore_null_padding_in_attr(const u8 *pos, u16 type, u16 attr_data_len)
{
 ...
 if (len == 0)
  return 0;
# 159 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/wps/wps_attr_parse.c"
 return len;
}
...
int wps_parse_msg(const struct wpabuf *msg, struct wps_parse_attr *attr)
{
 ...
 while (pos < end) {
  ...
  if (len > end - pos) {
   do {} while(0);
   do {} while(0);
# 642 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/wps/wps_attr_parse.c"
   return -1;
  }
# 664 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/wpa_supplicant/src/wps/wps_attr_parse.c"
