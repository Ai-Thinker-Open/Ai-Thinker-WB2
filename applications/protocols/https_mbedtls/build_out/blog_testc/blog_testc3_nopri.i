# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc3_nopri.c"
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc3_nopri.c" 2
...
# 512 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc3_nopri.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc3_nopri.c" 2

void blog_testc3_entry(void *arg)
{
    aos_msleep(5000);

    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc3_nopri)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc3 debug\r\n" "\r\n", "DEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc3_nopri.c", 11); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc3_nopri)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc3 info\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc3_nopri.c", 12); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc3_nopri)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc3 warn\r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc3_nopri.c", 13); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc3_nopri)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc3 error\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc3_nopri.c", 14); } } while (0 == 1); };

    while (1) {
        aos_msleep(5000);
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc3_nopri)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc3 debug\r\n" "\r\n", "DEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc3_nopri.c", 18); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc3_nopri)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc3 info\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc3_nopri.c", 19); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc3_nopri)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc3 warn\r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc3_nopri.c", 20); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc3_nopri)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc3 error\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc3_nopri.c", 21); } } while (0 == 1); };
    }
}
...
# 27 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc3_nopri.c" 3 4
                                                  ((void *)0)
# 27 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc3_nopri.c"
                                                      , 2048);
