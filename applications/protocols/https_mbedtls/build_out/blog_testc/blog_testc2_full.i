# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc2_full.c"
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc2_full.c" 2
...
# 512 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc2_full.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc2_full.c" 2
...
void test_buf(void)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("[%10u][%s: %s:%4d] %s:\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "DEBUG ", "blog_testc2_full.c", 18, "hexdumpbuf"); blog_hexdump_out("hexdumpbuf", 16, buf, sizeof(buf)); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("[%10u][%s: %s:%4d] %s:\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[32mINFO\x1b[0m", "blog_testc2_full.c", 19, "hexdumpbuf"); blog_hexdump_out("hexdumpbuf", 16, buf, sizeof(buf)); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("[%10u][%s: %s:%4d] %s:\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[33mWARN\x1b[0m", "blog_testc2_full.c", 20, "hexdumpbuf"); blog_hexdump_out("hexdumpbuf", 16, buf, sizeof(buf)); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("[%10u][%s: %s:%4d] %s:\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[31mERROR\x1b[0m", "blog_testc2_full.c", 21, "hexdumpbuf"); blog_hexdump_out("hexdumpbuf", 16, buf, sizeof(buf)); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ASSERT >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ASSERT >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("[%10u][%s: %s:%4d] %s:\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[35mDUMP\x1b[0m", "blog_testc2_full.c", 22, "hexdumpbuf"); blog_hexdump_out("hexdumpbuf", 16, buf, sizeof(buf)); } } while (0 == 1); };
}
void blog_testc2_entry(void *arg)
{
    aos_msleep(5000);

    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc2 debug\r\n" "\r\n", "DEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc2_full.c", 28); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc2 info\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc2_full.c", 29); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc2 warn\r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc2_full.c", 30); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc2 error\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc2_full.c", 31); } } while (0 == 1); };

    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_DEBUG >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 debug user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "DEBUG ", "blog_testc2_full.c", 33); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_INFO >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 info user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[32mINFO\x1b[0m", "blog_testc2_full.c", 34); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_WARN >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 warn user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[33mWARN\x1b[0m", "blog_testc2_full.c", 35); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_ERROR >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 error user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[31mERROR\x1b[0m", "blog_testc2_full.c", 36); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ASSERT >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ASSERT >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_ASSERT >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 assert user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[35mASSERT\x1b[0m", "blog_testc2_full.c", 37); } } while (0 == 1); };
    ...
    while (1) {
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc2 debug\r\n" "\r\n", "DEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc2_full.c", 44); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc2 info\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc2_full.c", 45); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc2 warn\r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc2_full.c", 46); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc2_full)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc2 error\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc2_full.c", 47); } } while (0 == 1); };

        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_DEBUG >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 debug user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "DEBUG ", "blog_testc2_full.c", 49); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_INFO >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 info user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[32mINFO\x1b[0m", "blog_testc2_full.c", 50); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_WARN >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 warn user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[33mWARN\x1b[0m", "blog_testc2_full.c", 51); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_ERROR >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 error user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[31mERROR\x1b[0m", "blog_testc2_full.c", 52); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ASSERT >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ASSERT >= _fsymf_level_blog_testcblog_testc2_full) && (BLOG_LEVEL_ASSERT >= _fsymp_level_blog_testc2)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc2 assert user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[35mASSERT\x1b[0m", "blog_testc2_full.c", 53); } } while (0 == 1); };
    }
}
...
# 59 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc2_full.c" 3 4
                                                  ((void *)0)
# 59 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc2_full.c"
                                                      , 2048);
