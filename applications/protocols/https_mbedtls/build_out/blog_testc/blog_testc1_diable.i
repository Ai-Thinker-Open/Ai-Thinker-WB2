# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc1_diable.c"
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc1_diable.c" 2
...
# 512 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc1_diable.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc1_diable.c" 2
...
void blog_testc1_entry(void *arg)
{
    ...
    if (0 == 1) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc1_diable)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc1 debug\r\n" "\r\n", "DEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc1_diable.c", 14); } } while (0 == 1); };
    if (0 == 1) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc1_diable)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc1 info\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc1_diable.c", 15); } } while (0 == 1); };
    if (0 == 1) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc1_diable)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc1 warn\r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc1_diable.c", 16); } } while (0 == 1); };
    if (0 == 1) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc1_diable)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc1 error\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc1_diable.c", 17); } } while (0 == 1); };

    if (0 == 1) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_DEBUG >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 debug user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "DEBUG ", "blog_testc1_diable.c", 19); } } while (0 == 1); };
    if (0 == 1) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_INFO >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 info user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[32mINFO\x1b[0m", "blog_testc1_diable.c", 20); } } while (0 == 1); };
    if (0 == 1) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_WARN >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 warn user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[33mWARN\x1b[0m", "blog_testc1_diable.c", 21); } } while (0 == 1); };
    if (0 == 1) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_ERROR >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 error user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[31mERROR\x1b[0m", "blog_testc1_diable.c", 22); } } while (0 == 1); };
    if (0 == 1) { do { if ((BLOG_LEVEL_ASSERT >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ASSERT >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_ASSERT >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 assert user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[35mASSERT\x1b[0m", "blog_testc1_diable.c", 23); } } while (0 == 1); };

    while (1) {
        aos_msleep(5000);
        if (0 == 1) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc1_diable)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc1 debug\r\n" "\r\n", "DEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc1_diable.c", 27); } } while (0 == 1); };
        if (0 == 1) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc1_diable)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc1 info\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc1_diable.c", 28); } } while (0 == 1); };
        if (0 == 1) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc1_diable)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc1 warn\r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc1_diable.c", 29); } } while (0 == 1); };
        if (0 == 1) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc1_diable)) { bl_printk("%s (%d)[%s:%4d] " "blog_testc1 error\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "blog_testc1_diable.c", 30); } } while (0 == 1); };

        if (0 == 1) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_DEBUG >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 debug user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "DEBUG ", "blog_testc1_diable.c", 32); } } while (0 == 1); };
        if (0 == 1) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_INFO >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 info user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[32mINFO\x1b[0m", "blog_testc1_diable.c", 33); } } while (0 == 1); };
        if (0 == 1) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_WARN >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 warn user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[33mWARN\x1b[0m", "blog_testc1_diable.c", 34); } } while (0 == 1); };
        if (0 == 1) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_ERROR >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 error user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[31mERROR\x1b[0m", "blog_testc1_diable.c", 35); } } while (0 == 1); };
        if (0 == 1) { do { if ((BLOG_LEVEL_ASSERT >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ASSERT >= _fsymf_level_blog_testcblog_testc1_diable) && (BLOG_LEVEL_ASSERT >= _fsymp_level_blog_testc1)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc1 assert user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[35mASSERT\x1b[0m", "blog_testc1_diable.c", 36); } } while (0 == 1); };
    }
}
...
# 42 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc1_diable.c" 3 4
                                                  ((void *)0)
# 42 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc1_diable.c"
                                                      , 2048);
