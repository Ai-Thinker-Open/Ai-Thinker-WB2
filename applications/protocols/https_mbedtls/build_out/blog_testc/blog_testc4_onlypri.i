# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc4_onlypri.c"
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc4_onlypri.c" 2
...
# 512 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc4_onlypri.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc4_onlypri.c" 2
...
void blog_testc4_entry(void *arg)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_DEBUG >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 debug user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "DEBUG ", "blog_testc4_onlypri.c", 13); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_INFO >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 info user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[32mINFO\x1b[0m", "blog_testc4_onlypri.c", 14); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_WARN >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 warn user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[33mWARN\x1b[0m", "blog_testc4_onlypri.c", 15); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_ERROR >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 error user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[31mERROR\x1b[0m", "blog_testc4_onlypri.c", 16); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ASSERT >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ASSERT >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_ASSERT >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 assert user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[35mASSERT\x1b[0m", "blog_testc4_onlypri.c", 17); } } while (0 == 1); };

    while (1) {
        aos_msleep(5000);
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_blog_testc) && (BLOG_LEVEL_DEBUG >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_DEBUG >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 debug user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "DEBUG ", "blog_testc4_onlypri.c", 21); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_blog_testc) && (BLOG_LEVEL_INFO >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_INFO >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 info user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[32mINFO\x1b[0m", "blog_testc4_onlypri.c", 22); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_blog_testc) && (BLOG_LEVEL_WARN >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_WARN >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 warn user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[33mWARN\x1b[0m", "blog_testc4_onlypri.c", 23); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ERROR >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_ERROR >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 error user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[31mERROR\x1b[0m", "blog_testc4_onlypri.c", 24); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ASSERT >= _fsymc_level_blog_testc) && (BLOG_LEVEL_ASSERT >= _fsymf_level_blog_testcblog_testc4_onlypri) && (BLOG_LEVEL_ASSERT >= _fsymp_level_blog_testc4)) { bl_printk("[%d][%s: %s:%4d] " "blog_testc4 assert user\r\n" "\r\n", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "\x1b[35mASSERT\x1b[0m", "blog_testc4_onlypri.c", 25); } } while (0 == 1); };
    }
}
...
# 31 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc4_onlypri.c" 3 4
                                                  ((void *)0)
# 31 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blog_testc/blog_testc4_onlypri.c"
                                                      , 2048);
