# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.h" 1
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
...
static uint8_t *get_avaible_area(void)
{
    ...
    return 
# 127 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
          ((void *)0)
# 127 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
              ;
}
...
static uint8_t *find_addr_by_key(uint8_t *key)
{
    ...
    return 
# 147 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
          ((void *)0)
# 147 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
              ;
}
...
int hal_hbnram_alloc(const char *key, int len)
{
    ...
    if ((strlen(key) > 4) || (len <= 0)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "illegal para. \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 228); } } while (0 == 1); };
        return -1;
    }

    paddr = get_avaible_area();
    if (paddr == 
# 233 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 233 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "do not have area for alloc. \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 234); } } while (0 == 1); };
        return -1;
    }
...
int hal_hbnram_buffer_set(const char *key, uint8_t *buf, int length)
{
    ...
    if (key == 
# 274 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 274 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || buf == 
# 274 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                             ((void *)0) 
# 274 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                  || length <= 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "illegal para \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 275); } } while (0 == 1); };

        return -1;
    }

    if (strlen(key) > 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "key oversize \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 281); } } while (0 == 1); };
        return -1;
    }
    ...
    if (phead == 
# 288 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 288 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "not correct key, return \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 289); } } while (0 == 1); };
...
int hal_hbnram_buffer_get(const char *key, uint8_t *buf, int length)
{
    ...
    if (buf == 
# 329 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 329 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || key == 
# 329 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                             ((void *)0) 
# 329 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                  || length <=0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "illegal para \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 330); } } while (0 == 1); };
        return -1;
    }

    if (strlen(key) > 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "key oversize \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 335); } } while (0 == 1); };
    }
    ...
    phead = find_addr_by_key(keybuf);
    if (phead == 
# 341 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 341 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "key not correct, return \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 342); } } while (0 == 1); };
        return -1;
    }

    area_size = *(uint32_t *)(phead + 4 + 4);
    if (length > area_size) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "length is big than alloc size \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 348); } } while (0 == 1); };
        return -1;
    }
...
int hal_hbnram_handle_get_fromkey(const char *key, hbnram_handle_t *handle)
{
    ...
    if (key == 
# 374 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 374 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || handle == 
# 374 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                                ((void *)0)
# 374 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "invalid handle pointer \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 375); } } while (0 == 1); };

        return -1;
    }

    if (strlen(key) > 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "key oversize \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 381); } } while (0 == 1); };
    }
    ...
    phead = find_addr_by_key(keybuf);
    if (phead == 
# 387 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 387 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "invalid key \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 388); } } while (0 == 1); };
        return -1;
    }
...
int hal_hbnram_copy_from_stream(hbnram_handle_t *handle, uint8_t *buf, int len)
{
    ...
    if (buf == 
# 408 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 408 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || handle == 
# 408 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                                ((void *)0)
# 408 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "invalid pointer \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 409); } } while (0 == 1); };
        return -1;
    }

    if (len <= 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "len == 0 \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 414); } } while (0 == 1); };
        return -1;
    }

    if (len + handle->read_idex > handle->size) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "len oversize \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 419); } } while (0 == 1); };
        return -1;
    }
...
int hal_hbnram_copy_to_stream(hbnram_handle_t *handle, uint8_t *buf, int len)
{
    ...
    if (buf == 
# 477 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 477 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || handle == 
# 477 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                                ((void *)0)
# 477 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "invalid  pointer. \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 478); } } while (0 == 1); };
    }

    if (len + handle->write_idex > handle->size) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "len oversize \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 482); } } while (0 == 1); };
    }

    if (len <= 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "len <= 0 , return \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 486); } } while (0 == 1); };
        return -1;
    }
