# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 40 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sec_eng.h"
...
void SEC_Eng_Turn_Off_Sec_Ring(void);
              ;
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt.h" 1
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt.h" 2

# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt_port.h" 1
# 33 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt_port.h"

# 33 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt_port.h"
typedef struct tag_bflb_crypt_cfg_t
{
# 45 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt_port.h"
    uint8_t type;
}bflb_crypt_cfg_t;
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt.h" 2
# 28 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt.h"
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
static void Aes_Compare_Data(const uint8_t *expected, uint8_t *input, uint32_t len)
{
    ...
    for (i = 0; i < len; i++) {
        if (input[i] != expected[i]) {
            is_failed = 1;
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "%s[%02d], %02x %02x\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 28, input[i] ==expected[i] ? "S" : "F", i, input[i], expected[i]); } } while (0 == 1); }
...
void Sec_Eng_AES_Link_Case_CBC_128(SEC_ENG_AES_ID_Type aesId)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CBC] IV Status After %08lx\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 115, linkCfg.aesSrcAddr); } } while (0 == 1); };
    _dump_iv_status(&linkCfg);
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CBC] IV Status After, %08lx\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 120, linkCfg.aesSrcAddr); } } while (0 == 1); };
    _dump_iv_status(&linkCfg);
...
# 336 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c"
    b[0] = 0;
    b[0] |= ( add_len > 0 ) << 6;
    b[0] |= ( ( tag_len - 2 ) / 2 ) << 3;
    b[0] |= q - 1;
    ...
    if( add_len > 0 )
    {
        ...
        BL602_MemSet( b, 0, 16 );
# 384 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c"
        cbc_adata_round = 1;
                         ...
                         const unsigned char *input, unsigned char *output, unsigned char *tag, size_t tag_len)
{
 ...
 unsigned char *b_input = 
# 563 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 3 4
                         ((void *)0)
# 563 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c"
                             ;
 unsigned char *b_output = 
# 564 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 3 4
                          ((void *)0)
# 564 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c"
                              ;
 int ret = 0;
...
exit:
 ...
 unsigned int ctr_length = 0;
    ...
    unsigned int b_output_size = 0;
    unsigned char *b_input = 
# 654 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 3 4
                             ((void *)0)
# 654 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c"
                                 ;
    unsigned char *b_output = 
# 655 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c" 3 4
                             ((void *)0)
# 655 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_aes.c"
                                 ;
    int ret = 0;
