# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 2
...
# 512 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.h" 2


# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.h"
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/utils/include/utils_sha256.h" 1
# 21 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/utils/include/utils_sha256.h"
typedef struct {
    uint32_t total[2];
    uint32_t state[8];
...
# 70 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/utils/include/utils_sha256.h"
...
# 90 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/utils/include/utils_sha256.h"
void utils_sha256(const uint8_t *input, uint32_t ilen, uint8_t output[32]);
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.h" 1
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 2
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 2
...
# 18 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                                   ((void *)0)
# 18 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                                       ;
...
int hosal_ota_start(uint32_t file_size)
{
    ...
    if (ota_parm != 
# 48 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                   ((void *)0)
# 48 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                       ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "ota had start\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 49); } } while (0 == 1); };
        return 0;
    }

    ota_parm = (hosal_ota_parm_t *)aos_malloc(sizeof(hosal_ota_parm_t));
    if (
# 54 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
       ((void *)0) 
# 54 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
            == ota_parm) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "have not enough memory\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 55); } } while (0 == 1); };
        return -1;
    }
    ...
    if (ret) {
        aos_free(ota_parm);
        ota_parm = 
# 65 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                  ((void *)0)
# 65 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                      ;
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "Open Default FW partition failed\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 66); } } while (0 == 1); };
        return -1;
    }
    ...
    if (hal_boot2_get_active_entries((0), &ptEntry)) {
        ...
        aos_free(ota_parm);
        ota_parm = 
# 73 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                  ((void *)0)
# 73 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                      ;

        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "PtTable_Get_Active_Entries fail\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 75); } } while (0 == 1); };
        return -1;
    }
    ...
    if (file_size > bin_size) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "file size is more than partition size\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 82); } } while (0 == 1); };
        bl_mtd_close(ota_parm->mtd_handle);
        aos_free(ota_parm);
        ota_parm = 
# 85 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                  ((void *)0)
# 85 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                      ;
        return -1;
    }

    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "Starting OTA test. OTA size is %lu\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 89, bin_size); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "[OTA] [TEST] activeIndex is %u, use OTA address=%08x\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 90, ptEntry.activeIndex, (unsigned int)ota_addr); } } while (0 == 1); };
# 105 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
    return ret;
}
...
int hosal_ota_update(uint32_t filesize, uint32_t offset, uint8_t *buf, uint32_t buf_len)
{
    ...
    if (ota_parm == 
# 111 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                   ((void *)0)
# 111 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                       ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "please start ota first\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 112); } } while (0 == 1); };
        return -1;
    }

    file_size = ota_parm->file_size;
    if ((filesize > file_size) || (
# 117 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                                  ((void *)0) 
# 117 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                                       == buf) || ((offset + buf_len) > file_size) || (buf_len == 0)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "parm is error!\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 118); } } while (0 == 1); };
        return -1;
    }

    ret = hosal_ota_erase(offset, buf_len);
    if (ret) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "erase failed\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 124); } } while (0 == 1); };
        return -1;
    }

    ret = bl_mtd_write(ota_parm->mtd_handle, offset, buf_len, buf);
    if (ret) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "mtd write failed\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 130); } } while (0 == 1); };
        return -1;
    }
...
{
    if (ota_parm == 
# 139 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                   ((void *)0)
# 139 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                       ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "please start ota first\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 140); } } while (0 == 1); };
        return -1;
    }
    uint32_t bin_size;
    HALPartition_Entry_Config ptEntry;
    ...
    if (ota_parm->file_size <= 32) {
        ...
        aos_free(ota_parm);
        ota_parm = 
# 149 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                  ((void *)0)
# 149 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                      ;
        return -1;
    }
    ...
    if (hal_boot2_get_active_entries((0), &ptEntry)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "PtTable_Get_Active_Entries fail\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 156); } } while (0 == 1); };
        bl_mtd_close(ota_parm->mtd_handle);
        aos_free(ota_parm);
        ota_parm = 
# 159 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                  ((void *)0)
# 159 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                      ;
        return -1;
    }
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "[OTA] prepare OTA partition info\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 162); } } while (0 == 1); };
    ...
    if (check_hash) {
        ...
        if (r_buf == 
# 174 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                    ((void *)0)
# 174 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                        ) {
            bl_mtd_close(ota_parm->mtd_handle);
            aos_free(ota_parm);
            ota_parm = 
# 177 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                      ((void *)0)
# 177 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                          ;
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "malloc error\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 178); } } while (0 == 1); };
            return -1;
        }
        ...
        while (offset < bin_size) {
            ...
            if (bl_mtd_read(ota_parm->mtd_handle, offset, read_size, r_buf)) {
                if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "mtd read failed\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 191); } } while (0 == 1); };
                bl_mtd_close(ota_parm->mtd_handle);
                aos_free(ota_parm);
                ota_parm = 
# 194 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                          ((void *)0)
# 194 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                              ;
                aos_free(r_buf);
                return -1;
            }
        ...
        for (i = 0; i < 32; i++) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "%02X" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 208, dst_sha[i]); } } while (0 == 1); };
        }
        puts("\r\nHeader SET SHA256 Checksum:");
        for (i = 0; i < 32; i++) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "%02X" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 212, sha_check[i]); } } while (0 == 1); };
        }

        if (memcmp(sha_check, (const void *)dst_sha, 32) != 0) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "sha256 check error\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 216); } } while (0 == 1); };
            bl_mtd_close(ota_parm->mtd_handle);
            aos_free(ota_parm);
            ota_parm = 
# 219 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                      ((void *)0)
# 219 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                          ;
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhosal_ota)) { bl_printk("%s (%d)[%s:%4d] " "[OTA] [TCP] Update PARTITION, partition len is %lu\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_ota.c", 228, ptEntry.len); } } while (0 == 1); };
    hal_boot2_update_ptable(&ptEntry);
    bl_mtd_close(ota_parm->mtd_handle);
    aos_free(ota_parm);
    ota_parm = 
# 232 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
              ((void *)0)
# 232 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                  ;
...
{
    if (ota_parm == 
# 243 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
                   ((void *)0)
# 243 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
                       ) {
    ...
    if ((
# 248 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c" 3 4
        ((void *)0) 
# 248 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_ota.c"
