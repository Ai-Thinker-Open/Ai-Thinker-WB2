# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
static int _get_gpio_max(const void* fdt, uint32_t dtb_offset)
{
    ...
    if (
# 48 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
       ((void *)0) 
# 48 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c"
            == addr_prop) {
        return -1;
    }
...
static int _get_gpio_config(const void* fdt, uint32_t dtb_offset, const char *name, struct gpio_feature_config *gpio_config)
{
    ...
    const uint32_t *addr_prop = 0;
    const char *result = 0;
# 73 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c"
    offset1 = fdt_subnode_offset(fdt, dtb_offset, name);
    if (offset1 < 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s NOT found\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 75, name); } } while (0 == 1); };
        return -1;
    }
    ...
    if ((lentmp != 4) || (memcmp("okay", result, 4) != 0)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "[%s] status = %s\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 84, name, result); } } while (0 == 1); };
        return 0;
    }

    addr_prop = fdt_getprop(fdt, offset1, "pin", &lentmp);
    if (addr_prop == 
# 89 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
                    ((void *)0)
# 89 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c"
                        ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "no pin found for %s\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 90, name); } } while (0 == 1); };
        return 0;
    }
    ...
    if (2 == lentmp && memcmp("Hi", result, 2) == 0) {
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s: unvalid GPIO config %3s\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 109, name, result); } } while (0 == 1); };
        return 0;
    }
    ...
    if (5 == lentmp && memcmp("blink", result, 5) == 0) {
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s: unvalid GPIO config %3s\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 121, name, result); } } while (0 == 1); };
        return 0;
    }

    addr_prop = fdt_getprop(fdt, offset1, "time", &lentmp);
    if (addr_prop == 
# 126 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
                    ((void *)0)
# 126 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c"
                        ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s: unvalid GPIO config\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 127, name); } } while (0 == 1); };
        return 0;
    }
...
int hal_gpio_init_from_dts(uint32_t fdt, uint32_t dtb_offset)
{
    ...
    for (i = 0; i < num; i++) {
        ...
        if (_get_gpio_config((const void*)fdt, dtb_offset, node, &gpio_config) < 0) {
            ...
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s: unvalid GPIO config\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 185, node); } } while (0 == 1); };
        }
    }
...
# 192 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
                                 ((void *)0)
# 192 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c"
                                     ;
int hal_gpio_register_handler(void *func, int gpioPin, int intCtrlMod, int intTrgMod, void *arg)
{
    if (
# 195 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
       ((void *)0) 
# 195 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c"
            == func || gpioPin > 31 || intCtrlMod > 1 || intTrgMod > 3) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "register paraments is not correct! \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 196); } } while (0 == 1); };
        return -1;
    }
    ...
    if (!pstgpio_head) {
        ...
        pstnode->next = 
# 216 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
                       ((void *)0)
# 216 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.c"
                           ;
    }
    else {
