# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
static void clk(void *para)
{
    ...
    vTaskExitCritical();
    vTaskDelete(
# 26 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c" 3 4
               ((void *)0)
# 26 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c"
                   );
}
...
static void cmd_clk_change(char *buf, int len, int argc, char **argv)
{
    para_div clk_div;
    if (3 != argc) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_sys_cli)) { bl_printk("%s (%d)[%s:%4d] " "please input para!\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sys_cli.c", 33); } } while (0 == 1); };
        return;
    } else {
        clk_div.hdiv = atoi(argv[1]);
        clk_div.bdiv = atoi(argv[2]);
        xTaskCreate(clk, (char*)"clk", 512, &clk_div, 20, 
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c" 3 4
                                                         ((void *)0) 
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sys_cli.c"
                                                              );
    }
}
