# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 2

# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_boot2.h" 1
# 39 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_boot2.h"
...
# 40 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_boot2.h" 2
...
BL_Err_Type SFlash_Write_Reg_With_Cmd(SPI_Flash_Cfg_Type *flashCfg,uint8_t writeRegCmd,uint8_t *regValue,
                                      uint8_t regLen);
# 41 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_boot2.h" 2
...
# 42 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_boot2.h" 2
# 58 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_boot2.h"
typedef enum {
    PT_ERROR_SUCCESS,
...
# 163 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_boot2.h"
...
PtTable_Error_Type PtTable_Get_Active_Entries_By_Name(PtTable_Stuff_Config *ptStuff,
                                                    uint8_t *name,
                                                    PtTable_Entry_Config *ptEntry);
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 2
# 22 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
static struct {
...
# 41 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 3 4
                              ((void *)0)
# 41 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
...
static void _dump_partition(void)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "======= PtTable_Config @%p=======\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 53, part); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "magicCode 0x%08X;" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 54, (unsigned int)(part->ptTable.magicCode)); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk(" version 0x%04X;" "\r\n", part->ptTable.version); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk(" entryCnt %u;" "\r\n", part->ptTable.entryCnt); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk(" age %lu;" "\r\n", part->ptTable.age); } } while (0 == 1); };
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "idx  type device activeIndex     name   Address[0]  Address[1]  Length[0]   Length[1]   age\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 60); } } while (0 == 1); };
    for (i = 0; i < part->ptTable.entryCnt; i++) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "[%02d] " "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 62, i); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk(" %02u" "\r\n", part->ptEntries[i].type); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("     %u" "\r\n", part->ptEntries[i].device); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("         %u" "\r\n", part->ptEntries[i].activeIndex); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("      %8s" "\r\n", part->ptEntries[i].name); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("  %p" "\r\n", (void*)(part->ptEntries[i].Address[0])); } } while (0 == 1); };
...
int hal_boot2_partition_bus_addr(const char *name, uint32_t *addr0, uint32_t *addr1, uint32_t *size0, uint32_t *size1, int *active)
{
    ...
    if ((0x54504642) != boot2_partition_table.table.ptTable.magicCode) {
        return -
# 90 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               5
# 90 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
                  ;
    }
    ...
    if (boot2_partition_table.table.ptTable.entryCnt == i) {
        return -
# 100 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               2
# 100 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
                     ;
    }
    ...
    *size1 = boot2_partition_table.table.ptEntries[i].maxLen[1];
    ...
    if (boot2_partition_table.table.ptTable.entryCnt == i) {
        return -
# 115 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               140
# 115 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
                        ;
    }
    ...
    if ( (addr0_t && (addr0_t < boot2_partition_table.table.ptEntries[i].Address[0])) ||
        ...
        return -
# 122 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               22
# 122 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
                     ;
    }
    if ((0 != boot2_partition_table.table.ptEntries[i].activeIndex) &&
        (1 != boot2_partition_table.table.ptEntries[i].activeIndex)) {
        return -
# 126 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               14
# 126 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
                     ;
    }
...
int hal_boot2_partition_addr(const char *name, uint32_t *addr0, uint32_t *addr1, uint32_t *size0, uint32_t *size1, int *active)
{
    ...
    if ((0x54504642) != boot2_partition_table.table.ptTable.magicCode) {
        return -
# 169 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               5
# 169 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
                  ;
    }
    ...
    if (boot2_partition_table.table.ptTable.entryCnt == i) {
        return -
# 179 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               2
# 179 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
                     ;
    }
...
int hal_boot2_init(void)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "[HAL] [BOOT2] Active Partition[%u] consumed %d Bytes\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 253, boot2_partition_table.partition_active_idx, sizeof(PtTable_Stuff_Config)); } } while (0 == 1); }
...
# 277 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c" 3 4
                                    ((void *)0)
# 277 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_boot2.c"
                                        , !boot2_partition_table.partition_active_idx, &boot2_partition_table.table, &ptEntry_media);

                if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "===== update mfg partition =====\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 279); } } while (0 == 1); };
            }
        }
    }

    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "====================\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 284); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "update mfg table.\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 285); } } while (0 == 1); };
}
