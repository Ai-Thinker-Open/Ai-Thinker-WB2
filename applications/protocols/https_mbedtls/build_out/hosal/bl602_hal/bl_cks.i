# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.h" 1


int bl_cks_test(void);
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
static void _bl_cks_test_case3()
{
    ...
    *(volatile uint8_t*)0x4000A700 = 0x1;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS LE result is %04x, %04x\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 113, cks, (uint16_t)~checksum); } } while (0 == 1); }
    ...
    *(volatile uint8_t*)0x4000A700 = 0x2;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS BE result is %04x, %04x\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 131, cks, (uint16_t)~checksum); } } while (0 == 1); }


     ;
    if (cks == ((uint16_t)~checksum)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Success %04X Checksum=====\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 136, cks); } } while (0 == 1); };
    } else {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Failed %04X Checksum======\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 138, cks); } } while (0 == 1); };
    }
}
...
static void _bl_cks_test_case4()
{
    ...
    *(volatile uint8_t*)0x4000A704 = data_segment_two;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS LE result is %04x, %04x\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 164, cks, (uint16_t)~checksum); } } while (0 == 1); }
    ...
    *(volatile uint8_t*)0x4000A704 = data_segment_two;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS BE result is %04x, %04x\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 184, cks, (uint16_t)~checksum); } } while (0 == 1); }


     ;
    if (cks == ((uint16_t)~checksum)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Success %04X Checksum=====\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 189, cks); } } while (0 == 1); };
    } else {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Failed %04X Checksum======\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 191, cks); } } while (0 == 1); };
    }
}
...
static void _cb_cmd(void *arg)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "[DMA] [TEST] Callback is working, arg is %p\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 200, arg); } } while (0 == 1); };
    first->arg = 
# 201 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
                ((void *)0)
# 201 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c"
                    ;
}
...
static void _bl_cks_test_case5()
{
    ...
    second.cb = 
# 248 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
               ((void *)0)
# 248 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c"
                   ;
    second.arg = 
# 249 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
                ((void *)0)
# 249 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c"
                    ;
    ...
    last.cb = 
# 263 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
             ((void *)0)
# 263 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c"
                 ;
    last.arg = 
# 264 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
              ((void *)0)
# 264 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_cks.c"
                  ;
    ...
    if (0x6DF1 == cks_result) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Success %04X Checksum=====\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 274, cks_result); } } while (0 == 1); };
    } else {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Failed %04X Checksum======\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 276, cks_result); } } while (0 == 1); };
    }
}

int bl_cks_test(void)
{
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case1 test\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 282); } } while (0 == 1); };
    _bl_cks_test_case1();
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case2 test\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 284); } } while (0 == 1); };
    _bl_cks_test_case2();
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case3 test\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 286); } } while (0 == 1); };
    _bl_cks_test_case3();
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case4 test\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 288); } } while (0 == 1); };
    _bl_cks_test_case4();
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case5 test\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 290); } } while (0 == 1); };
    _bl_cks_test_case5();
    return 0;
}
