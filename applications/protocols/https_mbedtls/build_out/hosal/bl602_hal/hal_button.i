# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
...
# 57 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blfdt/inc/libfdt_env.h" 2
...
# 59 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/blfdt/inc/libfdt_env.h" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
...
# 512 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
...
# 16 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
...
# 17 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_gpio.h" 1
...
# 18 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.h" 1



void fdt_button_module_init(const void *fdt, int button_offset);
# 19 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_hbn.h" 1



int hal_hbn_init(uint8_t *pinbuf, uint8_t pinbuf_size);
int hal_hbn_enter(uint32_t time);
# 20 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 2
# 28 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
...
static int accumulate_time(button_ctx_t *pstnode)
{
    ...
    if (
# 56 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
       ((void *)0) 
# 56 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
            == pstnode) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "NULL pointer \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 57); } } while (0 == 1); };
        return -1;
    }
...
# 89 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
       ((void *)0)
# 89 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
       , ( 0 ) ) != ( ( ( BaseType_t ) 1 ) )) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "stop timer failed \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 90); } } while (0 == 1); };
    }
...
# 116 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
               ((void *)0)
# 116 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
               , ( 100 ) ) != ( ( ( BaseType_t ) 1 ) )) {
                if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "change period failed \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 117); } } while (0 == 1); };
                button_int_umask(pstnode);
                clear_button_states(pstnode);
        ...
        case 2:
        {
            ...
            if (accu_time > pstnode->long_press_end_ms) {
                ...
                ret = check_button_is_up(pstnode);
                if (ret == 0) {
                    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "process not defined press time \r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 187); } } while (0 == 1); };
                    clear_button_states(pstnode);
                    button_int_umask(pstnode);
                    return;
                }
...
static int hal_button_register_handler_with_dts(gpio_ctx_t *pstgpio)
{
    ...
    if (
# 247 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
       ((void *)0) 
# 247 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
            == pstgpio) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "pstgpio can not be NULL \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 248); } } while (0 == 1); };
        return -1;
    }
...
# 372 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
        ...
        if (0 >= offset3) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "gpio[%d] short_press_ms feature NULL \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 382, i); } } while (0 == 1); };
            continue;
        }
        addr_prop = fdt_getprop(fdt, offset3, "start", &lentmp);
        if (addr_prop == 
# 386 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 386 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
                            ) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "press start  NULL. \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 387); } } while (0 == 1); };
            continue;
        }
        ...
        if (addr_prop == 
# 393 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 393 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
                            ) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "press end  NULL. \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 394); } } while (0 == 1); };
            continue;
        }
        ...
        if (addr_prop == 
# 400 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 400 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
                            ) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "gpio[%d] kevnet  NULL. \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 401, i); } } while (0 == 1); };
            continue;
        }
        ...
        if (0 >= offset3) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "long_press_ms feature NULL \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 409); } } while (0 == 1); };
        }
        addr_prop = fdt_getprop(fdt, offset3, "start", &lentmp);
        if (addr_prop == 
# 412 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 412 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
                            ) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "press start pin NULL. \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 413); } } while (0 == 1); };
            continue;
        }
        ...
        addr_prop = fdt_getprop(fdt, offset3, "end", &lentmp);
        if (addr_prop == 
# 419 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 419 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
                            ) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "press end pin NULL. \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 420); } } while (0 == 1); };
            continue;
        }
        ...
        addr_prop = fdt_getprop(fdt, offset3, "kevent", &lentmp);
        if (addr_prop == 
# 426 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 426 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
                            ) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "gpio[%d] kevent NULL. \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 427, i); } } while (0 == 1); };
            continue;
        }
        ...
        if (0 >= offset3) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "long_press_ms feature NULL \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 435); } } while (0 == 1); };
        }
        addr_prop = fdt_getprop(fdt, offset3, "start", &lentmp);
        if (addr_prop == 
# 438 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 438 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
                            ) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "press start pin NULL. \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 439); } } while (0 == 1); };
            continue;
        }
        ...
        addr_prop = fdt_getprop(fdt, offset3, "kevent", &lentmp);
        if (addr_prop == 
# 445 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c" 3 4
                        ((void *)0)
# 445 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hal_button.c"
                            ) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalhal_button)) { bl_printk("%s (%d)[%s:%4d] " "gpio[%d] kevent NULL \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_button.c", 446); } } while (0 == 1); };
            continue;
        }
