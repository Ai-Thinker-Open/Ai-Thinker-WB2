# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/soc/bl602/freertos_riscv_ram/panic/panic.h" 1
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_wdt.h" 1


int bl_wdt_init(int ms);
void bl_wdt_feed(void);
void bl_wdt_disable(void);
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 2


# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/coredump/inc/bl_coredump.h" 1
...
# 15 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
void bl_irq_register_with_ctx(int irqnum, void *handler, void *ctx)
{
    ...
    if (handler == 
# 106 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                  ((void *)0)
# 106 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c"
                      ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "handler is NULL pointer! \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 107); } } while (0 == 1); };
        return;
    }

    if (
# 111 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
       ((void *)0) 
# 111 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c"
            == ctx) {
        handler_list[0][irqnum] = handler;
        handler_list[1][irqnum] = 
# 113 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                                 ((void *)0)
# 113 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c"
                                     ;
    }
    else {
        handler_list[0][irqnum] = handler;
...
# 134 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                                             ((void *)0)
# 134 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c"
                                                 );
}
...
# 142 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                             ((void *)0)
# 142 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c"
                                 ;
}
...
{
    void *handler = 
# 147 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                   ((void *)0)
# 147 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_irq.c"
                       ;
    mcause &= 0x7FFFFFF;
