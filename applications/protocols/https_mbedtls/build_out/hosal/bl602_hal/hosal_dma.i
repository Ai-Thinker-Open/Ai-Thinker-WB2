# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
...
# 21 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/include/hosal_dma.h"
...
# 22 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/include/hosal_dma.h" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 14 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 15 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 2

static hosal_dma_dev_t *gp_hosal_dma_dev = 
# 16 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 3 4
                                          ((void *)0)
# 16 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
                                              ;
...
int hosal_dma_init(void)
{
 ...
 gp_hosal_dma_dev = calloc(sizeof(hosal_dma_dev_t), 1);
    if (gp_hosal_dma_dev == 
# 83 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 3 4
                           ((void *)0)
# 83 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
                               ) {
     if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "no memory !!!\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 84); } } while (0 == 1); };
    }
...
# 89 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 3 4
                                      ((void *)0)
# 89 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
                                          ) {
     if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "no memory !!!\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 90); } } while (0 == 1); };
    }
    DMA_Enable();
...
# 134 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_chan_release(hosal_dma_chan_t chan)
{
 if (!gp_hosal_dma_dev) {
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 137); } } while (0 == 1); };
  return -1;
 }
...
# 146 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c" 3 4
                                             ((void *)0)
# 146 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
                                                 ;
 return 0;
}
# 157 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_chan_start(hosal_dma_chan_t chan)
{
 if (!gp_hosal_dma_dev) {
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 160); } } while (0 == 1); };
  return -1;
 }
...
# 177 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_chan_stop(hosal_dma_chan_t chan)
{
 if (!gp_hosal_dma_dev) {
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 180); } } while (0 == 1); };
  return -1;
 }
...
# 200 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_irq_callback_set(hosal_dma_chan_t chan, hosal_dma_irq_t pfn, void *p_arg)
{
 if (!gp_hosal_dma_dev) {
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 203); } } while (0 == 1); };
  return -1;
 }
 if (chan > gp_hosal_dma_dev->max_chans) {
  return -1;
...
# 223 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_finalize(void)
{
 if (!gp_hosal_dma_dev) {
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 226); } } while (0 == 1); };
  return -1;
 }
