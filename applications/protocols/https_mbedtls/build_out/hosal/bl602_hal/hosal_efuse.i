# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_efuse.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_efuse.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_efuse.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_efuse.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/include/hosal_efuse.h" 1
# 20 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/include/hosal_efuse.h"
int hosal_efuse_read(uint32_t addr, uint32_t *data, uint32_t len);
# 33 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/include/hosal_efuse.h"
int hosal_efuse_write(uint32_t addr, uint32_t *data, uint32_t len);
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/hosal_efuse.c" 2

int hosal_efuse_read(uint32_t addr, uint32_t *data, uint32_t len)
{

    if (addr % 4 || (uint32_t)data % 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_efuse)) { bl_printk("%s (%d)[%s:%4d] " "parameter error!\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_efuse.c", 10); } } while (0 == 1); };
        return -1;
    }
...
int hosal_efuse_write(uint32_t addr, uint32_t *data, uint32_t len)
{
    ...
    if (addr % 4 || (uint32_t)data % 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_efuse)) { bl_printk("%s (%d)[%s:%4d] " "parameter error!\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_efuse.c", 25); } } while (0 == 1); };
        return -1;
    }
