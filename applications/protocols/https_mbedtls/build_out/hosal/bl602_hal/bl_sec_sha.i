# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c" 2
...
void SEC_Eng_Turn_Off_Sec_Ring(void);
              ;
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c" 2
...
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c" 2
...
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c" 2
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c" 2
...
int bl_sha_mutex_take()
{
    if (( ( ( BaseType_t ) 1 ) ) != xQueueSemaphoreTake( ( g_bl_sec_sha_mutex ), ( ( TickType_t ) 0xffffffffUL ) )) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_sec_sha)) { bl_printk("%s (%d)[%s:%4d] " "sha semphr take failed\r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_sha.c", 25); } } while (0 == 1); };
        return -1;
    }
    return 0;
}
...
# 33 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c" 3 4
                 ((void *)0)
# 33 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec_sha.c"
                 , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) )) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_sec_sha)) { bl_printk("%s (%d)[%s:%4d] " "sha semphr give failed\\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_sha.c", 34); } } while (0 == 1); };
        return -1;
    }
    return 0;
}
