# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
void SEC_Eng_Turn_Off_Sec_Ring(void);
              ;
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 512 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c" 2
# 21 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c"
...
# 25 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c" 3 4
                                      ((void *)0)
# 25 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c"
                                          ;
...
static inline void wait_trng4feed()
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_hosal) && (BLOG_LEVEL_DEBUG >= _fsymf_level_hosalbl_sec)) { bl_printk("%s (%d)[%s:%4d] " "Feed random number is %08lx\r\n" "\r\n", "DEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec.c", 62, trng_buffer[0]); } } while (0 == 1); };
...
void sec_trng_IRQHandler(void)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_hosal) && (BLOG_LEVEL_DEBUG >= _fsymf_level_hosalbl_sec)) { bl_printk("%s (%d)[%s:%4d] " "random number is %08lx\r\n" "\r\n", "DEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec.c", 142, trng_buffer[0]); } } while (0 == 1); };
    trng_buffer[0] = (*((volatile uint32_t*)(TRNGx+(0x8))));
    trng_buffer[1] = (*((volatile uint32_t*)(TRNGx+(0xc))));
    trng_buffer[2] = (*((volatile uint32_t*)(TRNGx+(0x10))));
    trng_buffer[3] = (*((volatile uint32_t*)(TRNGx+(0x14))));
...
static void RSA_Compare_Data(const uint8_t *expected, const uint8_t *input, uint32_t len)
{
    ...
    for (i = 0; i < len; i++) {
        if (input[i] != expected[i]) {
            is_failed = 1;
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec)) { bl_printk("%s (%d)[%s:%4d] " "%s[%02d], %02x %02x\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec.c", 219, input[i] ==expected[i] ? "S" : "F", i, input[i], expected[i]); } } while (0 == 1); }
...
# 519 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_sec.c"
