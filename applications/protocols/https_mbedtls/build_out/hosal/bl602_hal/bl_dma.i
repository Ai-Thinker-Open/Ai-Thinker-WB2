# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 2
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 2
...
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 2
...
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 2
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 2
...
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 2
# 31 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
struct dma_ctx {
...
void bl_dma_IRQHandler(void)
{
    ...
    if (
# 133 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
       ((void *)0) 
# 133 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
            == first) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_dma)) { bl_printk("%s (%d)[%s:%4d] " "[INT] ASSERT here for empty chain\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_dma.c", 134); } } while (0 == 1); };
        while (1) {
        }
    }
    if (first->cb) {
...
void *bl_dma_mem_malloc(uint32_t size)
{
    ...
    if (p_heap_addr == 
# 163 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                      ((void *)0)
# 163 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                          ) {
        return 
# 164 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
              ((void *)0)
# 164 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                  ;
    }

    ptr = 
# 167 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
         ((void *)0)
# 167 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
             ;
    counts = 0;
    while (1) {
        ...
        if (left_size < size || left_size < 1024) {
            ptr = 
# 172 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                 ((void *)0)
# 172 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                     ;
            goto __exit;
        }
        ...
        if (ptr == 
# 177 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                  ((void *)0)
# 177 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                      ) {
            goto __exit;
        }
...
static void bl_dma_int_process(void)
{
    ...
    void (*handler)(void) = 
# 212 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                           ((void *)0)
# 212 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                               ;
    ...
    for (ch = 0; ch < DMA_CH_MAX; ch++) {
        ...
        if((tc_flag != 0) || (interr_flag != 0)) {
            ...
            for (node = ((struct dma_node *) ((char *) ((pstctx->pstqueue)->next) - ((size_t)&(((struct dma_node *)0)->dlist_item)))); &node->dlist_item != (pstctx->pstqueue); node = ((struct dma_node *) ((char *) (node->dlist_item.next) - ((size_t)&(((struct dma_node *)0)->dlist_item))))) {
                if (ch == node->channel) {
                    if (node->tc_handler != 
# 243 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                                           ((void *)0) 
# 243 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                                                && tc_flag != 0) {
...
# 248 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                                               ((void *)0) 
# 248 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                                                    && interr_flag != 0) {
...
# 266 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                                                              ((void *)0)
# 266 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                                                                  ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_dma)) { bl_printk("%s (%d)[%s:%4d] " "not valid para \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_dma.c", 267); } } while (0 == 1); };
    ...
    for (node = ((struct dma_node *) ((char *) ((pstctx->pstqueue)->next) - ((size_t)&(((struct dma_node *)0)->dlist_item)))); &node->dlist_item != (pstctx->pstqueue); node = ((struct dma_node *) ((char *) (node->dlist_item.next) - ((size_t)&(((struct dma_node *)0)->dlist_item))))) {
        if (channel == node->channel) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalbl_dma)) { bl_printk("%s (%d)[%s:%4d] " "channel %d already register \r\n" "\r\n", "\x1b[33mWARN\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_dma.c", 275, node->channel); } } while (0 == 1); };
            return -1;
        }
    }
    pstnode = pvPortMalloc(sizeof(struct dma_node));
    if (pstnode == 
# 280 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                  ((void *)0)
# 280 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                      ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_dma)) { bl_printk("%s (%d)[%s:%4d] " "malloc dma node failed. \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_dma.c", 281); } } while (0 == 1); };
    }
...
void *bl_dma_find_node_by_channel(int channel)
{
    ...
    if (&(node->dlist_item) == pstctx->pstqueue) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_dma)) { bl_printk("%s (%d)[%s:%4d] " "not find channel register. \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_dma.c", 305); } } while (0 == 1); };

        return 
# 307 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
              ((void *)0)
# 307 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                  ;
    }
...
int bl_dma_irq_unregister(int channel)
{
    ...
    if (channel > DMA_CH_MAX || channel < 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_dma)) { bl_printk("%s (%d)[%s:%4d] " "not valid para \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_dma.c", 330); } } while (0 == 1); };
...
void bl_dma_init(void)
{
    ...
    if (pstctx == 
# 366 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                 ((void *)0)
# 366 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                     ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_dma)) { bl_printk("%s (%d)[%s:%4d] " "malloc dma ctx failed \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_dma.c", 367); } } while (0 == 1); };
    ...
    if (pstctx->pstqueue == 
# 373 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                           ((void *)0)
# 373 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                               ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_dma)) { bl_printk("%s (%d)[%s:%4d] " "malloc dma pstqueue failed \r\n" "\r\n", "\x1b[31mERROR\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_dma.c", 374); } } while (0 == 1); };
...
# 386 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                                                                    ((void *)0)
# 386 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                                                                        , 
# 386 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                                                                          ((void *)0)
# 386 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
...
static void _cb_cmd(void *arg)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_dma)) { bl_printk("%s (%d)[%s:%4d] " "[DMA] [TEST] Callback is working, arg is %p\r\n" "\r\n", "\x1b[32mINFO\x1b[0m", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_dma.c", 395, arg); } } while (0 == 1); };
    first->arg = 
# 396 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c" 3 4
                ((void *)0)
# 396 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_dma.c"
                    ;
}
