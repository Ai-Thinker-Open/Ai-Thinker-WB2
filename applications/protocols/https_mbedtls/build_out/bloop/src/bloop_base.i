# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/bloop//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/platform/hosal/bl602_hal/bl_timer.h"
uint32_t bl_timer_now_us(void);
void bl_timer_delay_us(uint32_t us);
uint64_t bl_timer_now_us64(void);
# 6 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/utils/include/utils_debug.h" 1
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 2
...
int bloop_handler_register(struct loop_ctx *loop, const struct loop_evt_handler *handler, int priority)
{
    ...
    if (
# 34 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
       ((void *)0) 
# 34 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
            == loop->handlers[priority]) {
        i = priority;
    } else {
        for (i = priority; i < (32); i++) {
            if (
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
               ((void *)0) 
# 38 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
                    == loop->handlers[priority]) {
                break;
            }
        }
...
int bloop_handler_unregister(struct loop_ctx *loop, const struct loop_evt_handler *handler, int priority)
{
    ...
    if (
# 58 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
       ((void *)0) 
# 58 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
            == loop->handlers[priority]) {
    ...
    loop->handlers[priority] = 
# 67 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                              ((void *)0)
# 67 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
                                  ;
    return 0;
}
...
# 107 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                             ((void *)0)
# 107 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
                                 , *node_pre = 
# 107 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                                               ((void *)0)
# 107 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
    ...
    if (utils_dlist_empty(&loop->timer_dlist)) {
        ...
        for (node = ((struct loop_timer *) ((char *) ((&loop->timer_dlist)->next) - ((size_t)&(((struct loop_timer *)0)->dlist_item)))); &node->dlist_item != (&loop->timer_dlist); node = ((struct loop_timer *) ((char *) (node->dlist_item.next) - ((size_t)&(((struct loop_timer *)0)->dlist_item))))) {
            if ((int)timer->time_target - (int)node->time_target <= 0) {
                ...
                if (
# 115 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                   ((void *)0) 
# 115 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
                        == node_pre) {
...
# 152 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
   ((void *)0)
# 152 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
...
{
    struct loop_timer *timer = 
# 167 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
                              ((void *)0)
# 167 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
                                  ;
    utils_dlist_t *tmp;
    int time2wait;
...
# 200 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
       ((void *)0)
# 200 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
...
# 278 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
}
...
{
    while (
# 287 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
          ((void *)0) 
# 287 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
               == loop->looper) {
        vTaskDelay(1);
    }
}
...
# 325 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c" 3 4
   ((void *)0) 
# 325 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/bloop/src/bloop_base.c"
   );
}
