# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/wifi_manager//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
# 10 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr.h" 2
...
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 2
...
# 14 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 2
...
int wifi_mgmr_profile_add(wifi_mgmr_t *mgmr, wifi_mgmr_profile_msg_t *profile_msg, int index, uint8_t isActive)
{
    ...
    profile = 
# 20 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
             ((void *)0)
# 20 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
                 ;
    ...
    if (
# 41 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
       ((void *)0) 
# 41 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
            == profile) {
        return -1;
    }
...
int wifi_mgmr_profile_add_by_idx(wifi_mgmr_t *mgmr, wifi_mgmr_profile_msg_t *profile_msg, int index, uint8_t isActive)
{
    ...
    profile = 
# 68 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
             ((void *)0)
# 68 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
                 ;
    ...
    if (
# 82 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
       ((void *)0) 
# 82 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
            == profile) {
        return -1;
    }
    memset(profile, 0, sizeof(*profile));
...
int wifi_mgmr_profile_del(wifi_mgmr_t *mgmr, char *ssid, int len)
{
    ...
    profile = 
# 110 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
             ((void *)0)
# 110 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
                 ;
    for (i = 0; i < sizeof(mgmr->profiles)/sizeof(mgmr->profiles[0]); i++) {
    ...
    if (
# 123 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
       ((void *)0) 
# 123 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
            == profile) {
        return -1;
    }
    memset(profile, 0, sizeof(*profile));
...
{
    wifi_mgmr_profile_t *profile = 
# 133 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
                                  ((void *)0)
# 133 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
                                      ;
...
int wifi_mgmr_profile_del_by_idx(wifi_mgmr_t *mgmr, uint8_t index)
{
    ...
    profile = 
# 152 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
             ((void *)0)
# 152 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
                 ;
    if (index < (2) && 1 == mgmr->profiles[index].isUsed) {
        profile = &(mgmr->profiles[index]);
    ...
    if (
# 160 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
       ((void *)0) 
# 160 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
            == profile) {
        return -1;
    }
    memset(profile, 0, sizeof(*profile));
...
int wifi_mgmr_profile_get_by_idx(wifi_mgmr_t *mgmr, wifi_mgmr_profile_msg_t *profile_msg, uint8_t index)
{
    ...
    profile = 
# 172 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
             ((void *)0)
# 172 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
                 ;
    if (index < (2) && 1 == mgmr->profiles[index].isUsed) {
        profile = &(mgmr->profiles[index]);
    ...
    if (
# 177 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
       ((void *)0) 
# 177 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
            == profile) {
...
int wifi_mgmr_profile_get(wifi_mgmr_t *mgmr, wifi_mgmr_profile_msg_t *profile_msg, uint8_t isActive)
{
    ...
    profile = 
# 204 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
             ((void *)0)
# 204 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
                 ;
    for (i = 0; i < sizeof(mgmr->profiles)/sizeof(mgmr->profiles[0]); i++) {
    ...
    if (
# 212 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
       ((void *)0) 
# 212 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
            == profile) {
...
{
    wifi_mgmr_profile_t *profile = 
# 236 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c" 3 4
                                  ((void *)0)
# 236 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
                                      ;
...
int wifi_mgmr_profile_autoreconnect_is_enabled(wifi_mgmr_t *mgmr, int index)
{
# 261 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
...
int wifi_mgmr_profile_autoreconnect_disable(wifi_mgmr_t *mgmr, int index)
{
# 277 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
...
int wifi_mgmr_profile_autoreconnect_enable(wifi_mgmr_t *mgmr, int index)
{
# 296 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_profile.c"
