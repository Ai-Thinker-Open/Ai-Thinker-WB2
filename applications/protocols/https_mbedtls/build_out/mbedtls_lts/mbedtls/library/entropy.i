# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/mbedtls_lts//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
# 50 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
...
# 51 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 2
# 61 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
...
# 62 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/include/mbedtls/sha512.h" 2
...
# 62 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/include/mbedtls/entropy_poll.h" 1
# 58 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/include/mbedtls/entropy_poll.h"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/10.2.0/include/stddef.h" 1 3 4
# 59 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/include/mbedtls/entropy_poll.h" 2
# 86 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/include/mbedtls/entropy_poll.h"
int mbedtls_platform_entropy_poll( void *data,
                           unsigned char *output, size_t len, size_t *olen );
# 63 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 2
...
# 64 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 2
...
# 66 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 2
...
# 69 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 2
# 90 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
...
# 119 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
    mbedtls_entropy_add_source( ctx, mbedtls_platform_entropy_poll, 
# 119 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 3 4
                                                                   ((void *)0)
# 119 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
                                                                       ,
                                32,
                                1 );
# 145 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
}
...
void mbedtls_entropy_free( mbedtls_entropy_context *ctx )
{
    ...
    if( ctx->accumulator_started == -1 )
        return;
# 161 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
...
# 260 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
cleanup:
...
int mbedtls_entropy_func( void *data, unsigned char *output, size_t len )
{
    ...
    if( len > 64 )
        return( -0x003C );
# 385 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
    do
    {
        if( count++ > 256 )
        {
    ...
    if( ( ret = mbedtls_sha512_ret( buf, 64,
                                    buf, 0 ) ) != 0 )
        goto exit;
# 454 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
    for( i = 0; i < ctx->source_count; i++ )
        ctx->source[i].size = 0;
...
# 494 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
int mbedtls_entropy_write_seed_file( mbedtls_entropy_context *ctx, const char *path )
{
    int ret = -0x003F;
    FILE *f;
    ...
    if( ( f = fopen( path, "wb" ) ) == 
# 500 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 3 4
                                      ((void *)0) 
# 500 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
                                           )
        return( -0x003F );
...
int mbedtls_entropy_update_seed_file( mbedtls_entropy_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 528 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 3 4
                                      ((void *)0) 
# 528 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
                                           )
        return( -0x003F );

    fseek( f, 0, 
# 531 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 3
                2 
# 531 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
                         );
    n = (size_t) ftell( f );
    fseek( f, 0, 
# 533 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c" 3
                0 
# 533 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/entropy.c"
                         );
