# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/mbedtls_lts//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
# 55 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
...
# 56 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 2
...
# 78 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/include/mbedtls/aes.h" 2
...
# 61 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 2
...
# 62 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 2
...
# 64 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 2
...
# 67 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 2
# 81 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
...
{
    if( ctx == 
# 94 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 3 4
              ((void *)0) 
# 94 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
                   )
        return;
...
# 149 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
    p = buf + 16;
    *p++ = ( data_len >> 24 ) & 0xff;
    *p++ = ( data_len >> 16 ) & 0xff;
    *p++ = ( data_len >> 8 ) & 0xff;
    ...
    *p++ = ( 32 + 16 );
    ...
    if( ( ret = mbedtls_aes_setkey_enc( &aes_ctx, key, ( 32 * 8 ) ) ) != 0 )
    {
        goto exit;
    }
    ...
    for( j = 0; j < ( 32 + 16 ); j += 16 )
    {
        ...
        while( use_len > 0 )
        {
            ...
            if( ( ret = mbedtls_aes_crypt_ecb( &aes_ctx, 1, chain, chain ) ) != 0 )
            {
                goto exit;
            }
        }
    ...
    if( ( ret = mbedtls_aes_setkey_enc( &aes_ctx, tmp, ( 32 * 8 ) ) ) != 0 )
    {
        goto exit;
    }
    iv = tmp + 32;
    ...
    for( j = 0; j < ( 32 + 16 ); j += 16 )
    {
        if( ( ret = mbedtls_aes_crypt_ecb( &aes_ctx, 1, iv, iv ) ) != 0 )
        {
            goto exit;
        }
        memcpy( p, iv, 16 );
...
# 247 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
                              ...
                              const unsigned char data[( 32 + 16 )] )
{
    ...
    for( j = 0; j < ( 32 + 16 ); j += 16 )
    {
        ...
        if( ( ret = mbedtls_aes_crypt_ecb( &ctx->aes_ctx, 1, ctx->counter, p ) ) != 0 )
            goto exit;
    ...
    if( ( ret = mbedtls_aes_setkey_enc( &ctx->aes_ctx, tmp, ( 32 * 8 ) ) ) != 0 )
        goto exit;
...
# 302 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_update_ret( mbedtls_ctr_drbg_context *ctx,
                                 const unsigned char *additional,
                                 size_t add_len )
{
...
# 347 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_reseed( mbedtls_ctr_drbg_context *ctx,
                     const unsigned char *additional, size_t len )
{
...
# 409 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_seed( mbedtls_ctr_drbg_context *ctx,
                           int (*f_entropy)(void *, unsigned char *, size_t),
                           void *p_entropy,
                           const unsigned char *custom,
                           size_t len )
{
    ...
    if( ( ret = mbedtls_aes_setkey_enc( &ctx->aes_ctx, key, ( 32 * 8 ) ) ) != 0 )
    {
        return( ret );
    }
...
# 478 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_random_with_add( void *p_rng,
                              unsigned char *output, size_t output_len,
                              const unsigned char *additional, size_t add_len )
{
    ...
    while( output_len > 0 )
    {
        ...
        if( ( ret = mbedtls_aes_crypt_ecb( &ctx->aes_ctx, 1, ctx->counter, tmp ) ) != 0 )
            goto exit;
...
# 562 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 3 4
                                                                    ((void *)0)
# 562 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
                                                                        , 0 );
...
int mbedtls_ctr_drbg_write_seed_file( mbedtls_ctr_drbg_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "wb" ) ) == 
# 579 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 3 4
                                      ((void *)0) 
# 579 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
                                           )
        return( -0x003A );
...
int mbedtls_ctr_drbg_update_seed_file( mbedtls_ctr_drbg_context *ctx, const char *path )
{
    int ret = 0;
    FILE *f = 
# 600 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 3 4
             ((void *)0)
# 600 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
                 ;
    size_t n;
    unsigned char buf[ 256 ];
    unsigned char c;
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 605 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 3 4
                                      ((void *)0) 
# 605 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
                                           )
        return( -0x003A );
    ...
    if( n == 0 || 
# 614 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 3
                 ((int)(((
# 614 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
                 f
# 614 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 3
                 )->_flags & 0x0040) != 0)) 
# 614 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
    ...
    fclose( f );
    f = 
# 620 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 3 4
       ((void *)0)
# 620 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
           ;
...
exit:
    mbedtls_platform_zeroize( buf, sizeof( buf ) );
    if( f != 
# 626 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c" 3 4
            ((void *)0) 
# 626 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/security/mbedtls_lts/mbedtls/library/ctr_drbg.c"
                 )
        fclose( f );
    if( ret != 0 )
        return( ret );
