# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2

# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/utils/include/utils_debug.h" 1
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/include/loopset_pwm.h" 1
...
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 2
...
static int _pwm_bloop_evt(struct loop_ctx *loop, const struct loop_evt_handler *handler, uint32_t *bitmap_evt, uint32_t *evt_type_map)
{
    ...
    if (trigger == 
# 29 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 3 4
                  ((void *)0)
# 29 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c"
                      ) {
        return -1;
    }
    if (map & (1U << 1)) {
...
int loopset_pwm_hook_on_looprt(void)
{
    static const struct loop_evt_handler _pwm_bloop_handler_holder = {
        ...
        .evt = _pwm_bloop_evt,
        .handle = 
# 45 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c" 3 4
                 ((void *)0)
# 45 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_pwm.c"
                     ,
    };
