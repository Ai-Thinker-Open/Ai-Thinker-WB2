# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/applications/protocols/https_mbedtls/build_out/loopset//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c"
...
# 2 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 3 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 4 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 5 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2

# 1 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/utils/include/utils_debug.h" 1
# 7 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 8 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 9 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 11 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 12 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 13 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 41 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c" 3 4
   ((void *)0)
# 41 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c"
...
{
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_loopset) && (BLOG_LEVEL_DEBUG >= _fsymf_level_loopsetloopset_led)) { bl_printk("%s (%d)[%s:%4d] " "[LED] [MSG] called with msg info\r\n" "    priority %u\r\n" "    dst %u\r\n" "    msgid %u\r\n" "    src %u\r\n" "    arg1 %p\r\n" "    arg2 %p\r\n" "\r\n", "DEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "loopset_led.c", 78, msg->u.header.priority, msg->u.header.id_dst, msg->u.header.id_msg, msg->u.header.id_src, msg->arg1, msg->arg2); } } while (0 == 1); }
# 91 "/mnt/d/GitHub/bl_iot_sdk_for_aithinker/components/sys/bloop/loopset/src/loopset_led.c"
     ;
    return 0;
}
