 ...
 */
#ifndef _AXK_TLS_CRYPTO_H
#define _AXK_TLS_CRYPTO_H
 ...
 * axk-tls abstraction for crypto sha1 API, calculates the sha1 sum(digest) of
 ...
 *               -  0   if succcessful.
 */
int axk_crypto_base64_encode(unsigned char *dst, size_t dlen,
