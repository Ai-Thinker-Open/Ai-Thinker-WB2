// Copyright 2015-2019 Axkressif Systems (Shanghai) PTE LTD
//
...
#if __has_include("axk_sdk_version.h")
#include "axk_sdk_version.h"
#endif

/**
 * @brief This header defines supported features of SDK which mqtt module
 *        could use depending on specific version of AXK-SDK.
 *        In case "axk_sdk_version.h" were not found, all additional
 *        features would be disabled
 */

// TODO
#if 0 // ORIGINAL
#ifdef AXK_SDK_VERSION

#if AXK_SDK_VERSION >= AXK_SDK_VERSION_VAL(3, 3, 0)
// Features supported from 3.3
#define MQTT_SUPPORTED_FEATURE_EVENT_LOOP
#define MQTT_SUPPORTED_FEATURE_SKIP_CRT_CMN_NAME_CHECK
#endif

#if AXK_SDK_VERSION >= AXK_SDK_VERSION_VAL(4, 0, 0)
...
#if AXK_SDK_VERSION >= AXK_SDK_VERSION_VAL(4, 1, 0)
...
#if AXK_SDK_VERSION >= AXK_SDK_VERSION_VAL(4, 2, 0)
// Features supported in 4.2
#define MQTT_SUPPORTED_FEATURE_SECURE_ELEMENT
#endif

#if AXK_SDK_VERSION >= AXK_SDK_VERSION_VAL(4, 3, 0)
