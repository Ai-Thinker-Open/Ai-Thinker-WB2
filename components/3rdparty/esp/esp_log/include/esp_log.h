...
#define ESP_LOGE( tag, format, ... ) do{(void)tag; blog_debug("[%s] " format "\r\n", tag, ##__VA_ARGS__);}while(0)
#define ESP_LOGW( tag, format, ... ) do{(void)tag; blog_warn("[%s] " format "\r\n", tag, ##__VA_ARGS__);}while(0)
#define ESP_LOGI( tag, format, ... ) do{(void)tag; blog_info("[%s] " format "\r\n", tag, ##__VA_ARGS__);}while(0)
#define ESP_LOGD( tag, format, ... ) do{(void)tag; blog_debug("[%s] " format "\r\n", tag, ##__VA_ARGS__);}while(0)
#define ESP_LOGV( tag, format, ... ) do{(void)tag; blog_debug("[%s] " format "\r\n", tag, ##__VA_ARGS__);}while(0)
